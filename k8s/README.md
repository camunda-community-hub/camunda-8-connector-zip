...
```shell
kubectl create -f c8-con-zip.yaml
```
...
Push the image to
```
docker build -t pierre-yves-monnet/c8-con-zip:3.1.0 .
```
...
```
docker tag pierre-yves-monnet/c8-con-zip:3.1.0 ghcr.io/camunda-community-hub/c8-con-zip:3.1.0
docker push ghcr.io/camunda-community-hub/c8-con-zip:3.1.0
```

Tag as the latest:

```
docker tag pierre-yves-monnet/c8-con-zip:3.1.0 ghcr.io/camunda-community-hub/c8-con-zip:latest
docker push ghcr.io/camunda-community-hub/c8-con-zip:latest
```

Check on https://github.com/camunda-community-hub/package/c8-con-zip
