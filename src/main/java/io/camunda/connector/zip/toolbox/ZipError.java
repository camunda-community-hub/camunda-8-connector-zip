...
public class ZipError {
    ...
    public static final String INVALID_COMPRESSION = "INVALID_COMPRESSION";
    public static final String INVALID_COMPRESSION_EXPLANATION = "Impossible to detect the compression (RAR or ZIP)";
    ...
    public static final String READ_FILE_EXPLANATION = "Read the file failed";

    public static final String WRITE_FILE = "WRITE_FILE";
    public static final String WRITE_FILE_EXPLANATION = "A file to the storage failed";
    ...
    public static final String  RAR_COMPRESSION_NOT_SUPPORTED = "RAR_COMPRESSION_NOT_SUPPORTED";
    public static final String  RAR_COMPRESSION_NOT_SUPPORTED_EXPLANATION = "The Rar compression is proprietary";
}
